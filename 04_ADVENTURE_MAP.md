...
### [Activity 1: Introduction to Tactile Graphics](embeds/adventure_map_activities/beginner/01_beginner.md)
...
### [Activity 2: Descriptive Language in Drawing](embeds/adventure_map_activities/beginner/02_beginner.md)
...
### [Activity 3: Tactile Colors](embeds/adventure_map_activities/beginner/03_beginner.md)
...
### [Activity 7: Code & Go Mouse](embeds/adventure_map_activities/intermediate/07_intermediate.md)
...
### [Activity 8: Colby's Mouse Town](embeds/adventure_map_activities/intermediate/08_intermediate.md)
...
### [Activity 9: Drawing with Colby](embeds/adventure_map_activities/intermediate/09_intermediate.md)
...
### [Activity 10: CodeQuest](embeds/adventure_map_activities/intermediate/10_intermediate.md)
...
### [Activity 11: Intro to Spatial Mapping](embeds/adventure_map_activities/advanced/11_advanced.md)
...
### [Activity 12: Digitizing Drawings with SVG Code](embeds/adventure_map_activities/advanced/12_advanced.md)
...
### [Activity 13: Iterating on SVG Drawings and Beyond](embeds/adventure_map_activities/advanced/13_advanced.md)
...
### [Moving from 2D to 3D Design (Overview of Activities 14–19)](embeds/adventure_map_activities/advanced/2D3DOverview.md)
...
- [Activity A.1. Create a Square in OpenSCAD](embeds/adventure_map_activities/advanced/14_advanced.md)
- [Activity A.2. Basic Shapes in OpenSCAD](embeds/adventure_map_activities/advanced/15_advanced.md)
- [Activity A.3. Rotating, Translating, Scaling and Mirroring Shapes](embeds/adventure_map_activities/advanced/16_advanced.md)

### Programming in OpenSCAD — Section B

- [Activity B.1. Adding and Subtracting Objects](embeds/adventure_map_activities/advanced/17_advanced.md)
- [Activity B.2. Moving from 2D to 3D](embeds/adventure_map_activities/advanced/18_advanced.md)
- [Activity B.3. True 3D Models](embeds/adventure_map_activities/advanced/19_advanced.md)

---

**Previous:** [Resources](02_RESOURCES.md) · **Next:** [Contact Us](05_CONTACT_US.md) · **Home:** [Home](README.md)
