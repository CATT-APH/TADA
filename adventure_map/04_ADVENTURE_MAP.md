...
[Print this page](https://www.printfriendly.com/print?url=https://github.com/aabdurmohammed-source/TADA/blob/main/adventure_map/04_ADVENTURE_MAP.md)

*(The Tangible Art and Design Adventure Map)*

## Introductory Points of Interest

### [Activity 1: Introduction to Tactile Graphics](../embeds/adventure_map_activities/beginner/1_beginner.md)
...
### [Activity 2: Descriptive Language in Drawing](../embeds/adventure_map_activities/beginner/2_beginner.md)
...
### [Activity 3: Tactile Colors](../embeds/adventure_map_activities/beginner/3_beginner.md)
...
### [Activity 4: Moving from 3D to 2D: Basic Shapes](../embeds/adventure_map_activities/beginner/4_beginner.md)
...
### [Activity 1: Code & Go Mouse](../embeds/adventure_map_activities/intermediate/1_intermediate.md)
...
### [Activity 2: Colby's Mouse Town](../embeds/adventure_map_activities/intermediate/2_intermediate.md)
...
### [Activity 3: Drawing with Colby](../embeds/adventure_map_activities/intermediate/3_intermediate.md)
...
### [Activity 4: CodeQuest](../embeds/adventure_map_activities/intermediate/4_intermediate.md)
...
### [Activity 1: Intro to Spatial Mapping](../embeds/adventure_map_activities/advanced/1_advanced.md)
...
### [Activity 2: Digitizing Drawings with SVG Code](../embeds/adventure_map_activities/advanced/2_advanced.md)
...
### [Activity 3: Iterating on SVG Drawings and Beyond](../embeds/adventure_map_activities/advanced/3_advanced.md)
...
### [Moving from 2D to 3D Design (Overview of Activities 4–9)](../embeds/adventure_map_activities/advanced/2D3DOverview.md)

### [Section A: Making 2D Shapes in OpenSCAD (Introduction to Activities 14–16)](../embeds/adventure_map_activities/advanced/2DIntro.md)

- [Activity A.1. Create a Square in OpenSCAD](../embeds/adventure_map_activities/advanced/4_advanced.md)
- [Activity A.2. Basic Shapes in OpenSCAD](../embeds/adventure_map_activities/advanced/5_advanced.md)
- [Activity A.3. Rotating, Translating, Scaling and Mirroring Shapes](../embeds/adventure_map_activities/advanced/6_advanced.md)

### Programming in OpenSCAD — Section B

- [Activity B.1. Adding and Subtracting Objects](../embeds/adventure_map_activities/advanced/7_advanced.md)
- [Activity B.2. Moving from 2D to 3D](../embeds/adventure_map_activities/advanced/8_advanced.md)
- [Activity B.3. True 3D Models](../embeds/adventure_map_activities/advanced/9_advanced.md)
