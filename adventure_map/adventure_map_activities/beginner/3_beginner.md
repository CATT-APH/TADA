...
- Pixel Paper
- Braille labels
- [APH Assorted textured paper (e.g., sandpaper, construction paper, tissue paper)](https://www.aph.org/product/textured-paper-collection/)
- [Color-By-Texture Marking Mats](https://www.aph.org/product/color-by-texture-marking-mats/)
...
**Previous:** [Activity 2: Descriptive Language and Drawing](2_beginner.md) · [Download the whole thing](https://github.com/aabdurmohammed-source/TADA/archive/refs/heads/main.zip) · **Next:** [Activity 4: Moving from 3D to 2D](4_beginner.md) · **Back to:** [Adventure Map](../../04_ADVENTURE_MAP.md)
