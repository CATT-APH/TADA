...
Students can begin progressing through the rest of [BlindSVG.com](https://blindsvg.com/) at their comfort and leisure if they are interested in learning more about the graphics creation process. Have the students think about what they can now create, and challenge them to get out there and try it for themselves!
...
**Previous:** [Activity 2: Digitizing Drawings with SVG Code](2_advanced.md) · [Download the whole thing](https://github.com/aabdurmohammed-source/TADA/archive/refs/heads/main.zip) · **Next:** [2D to 3D Overview](2D3DOverview.md) · **Back to:** [Adventure Map](../../04_ADVENTURE_MAP.md)
