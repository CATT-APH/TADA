...
**Previous:** [Activity B.2: Moving from 2D to 3D](8_advanced.md) · **Next:** [Section C: 3D Printable STEM Models](../../../dev/embeds/resources_page/3D_PRINTABLE_STEM_RESOURCES.md) · **Back to:** [Adventure Map](../../04_ADVENTURE_MAP.md) · [Download all TADA PDFs](../../../pdf/TADA-all-PDFs.zip)
