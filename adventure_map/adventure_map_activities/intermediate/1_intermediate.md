...
[Download this activity](../../../pdf/adventure_map/adventure_map_activities/intermediate/1_intermediate.pdf)
...
- [APH's Code & Go Robot Mouse](https://www.aph.org/product/accessible-code-and-go-mouse/)
- Assorted textured paper
- Stickers
- [Printable 5" x 5" squares](https://drive.google.com/file/d/1kTYYxIjHKID6RkKTCoDDkZu-y6w_pYr5/view?pli=1)
- Scissors
- Glue Stick
- Other art supplies
...
- To give your student additional opportunities to explore the idea of creating a town for Colby and be creative. Use the [5" x 5"](https://drive.google.com/file/d/1kTYYxIjHKID6RkKTCoDDkZu-y6w_pYr5/view?pli=1) square (this is the size of the tiles from Code and Go) and have your student draw out/ design the places in the town. Some examples are a School, Library, Park and Cheese Shop. Make sure to reiterate sketching techniques covered from the introductory adventures. They can use markers, stickers, textured paper, braille labels or any other art supplies you have.
...
[Download the whole thing](https://github.com/CATT-APH/TADA/archive/refs/heads/main.zip) · **Next:** [Activity 2: Colby's Mouse Town](2_intermediate.md) · **Back to:** [Adventure Map](../../04_ADVENTURE_MAP.md)
